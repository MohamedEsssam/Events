...
var UserNotFound_1 = __importDefault(require("../../exceptions/UserNotFound"));
var repository = new UserRepository_1.UserRepository(user_1.default);
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var request, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, repository.login(request["email"], request["password"])];
            case 2:
                user = _a.sent();
                if (!user)
