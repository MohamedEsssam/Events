...
var participate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, eventId, participate_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, repository.participate(id, eventId)];
            case 2:
                participate_1 = _a.sent();
                if (!participate_1)
                    return [2 /*return*/, res.status(NotFound_1.default.httpCode).send(NotFound_1.default)];
                return [2 /*return*/, res.status(200).send(participate_1)];
            case 3:
                error_1 = _a.sent();
