...
var unParticipate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, eventId, participate, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, repository.unParticipate(id, eventId)];
            case 2:
                participate = _a.sent();
                if (!participate)
...
exports.unParticipate = unParticipate;
