...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var request, organization, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, repository.register(request)];
            case 2:
                organization = _a.sent();
                if (!organization)
                    return [2 /*return*/, res.status(UserAlreadyExist_1.default.httpCode).send(UserAlreadyExist_1.default)];
